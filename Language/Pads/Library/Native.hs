...
bToi32 :: Pos -> (Bytes,Bytes_md) -> (Int32,Int32_md)
...
bTow8 :: Pos -> (Bytes,Bytes_md) -> (Word8,Word8_md)
...
bTow16 :: Pos -> (Bytes,Bytes_md) -> (Word16,Word16_md)
...
bTow32 :: Pos -> (Bytes,Bytes_md) -> (Data.Word.Word32,Word32_md)
