...
bar_expects =  ((Pint 256, (Pint 12, Pint 23), Pint 456), 0, ":")
...
baz_expects = ((PstringFW "cat",Pint 123),0,"")
...
expect_intRangeHigh = (Pint 512,1,"")
...
expect_intRangeBad  = (Pint 0,1,"aaa")
...
expect_intRangeP256 = (Pint 256,0,"")
...
expect_intRangePHigh = (Pint 512, 1,"")
...
expect_eor_test = ((Pint 23,Pint 56),0,"")
...
expect_eof_test_G = ((Pint 23,Pint 56),0,"")
...
expect_eof_test_B = ((Pint 23,Pint 56), 1,"ab")
...
expect_entries_nosep_noterm = ([PstringFW "123",PstringFW "456",PstringFW "789"],0,"")
...
result_entries_nosep_noterm' = entries_nosep_noterm_parseS input_entries_nosep_noterm'
expect_entries_nosep_noterm' = ([PstringFW "123",PstringFW "456",PstringFW "789"],0,"0")
test_entries_nosep_noterm' = mkTestCase "NoSep_NoTerm'" expect_entries_nosep_noterm' result_entries_nosep_noterm'
...
expect_digitListG = ([Pdigit 1,Pdigit 2,Pdigit 3],0,"")
...
expect_digitList2G = ([Pdigit 1,Pdigit 2,Pdigit 3],0,"|fed")
...
expect_digitListB = ([Pdigit 1],0,",b,3")
...
expect_digitListLenG = ([Pdigit 1,Pdigit 2,Pdigit 3,Pdigit 4,Pdigit 5],0,"6")
...
expect_digitListLenB = ([Pdigit 1,Pdigit 2,Pdigit 0,Pdigit 4,Pdigit 5],1 ,"6")
test_digitListLenB = mkTestCase "DigitListLenB" expect_digitListLenB result_digitListLenB


[pads| type DigitListLenSep (x::Int) = [Pdigit | "ab" ] length <|x + 1|>  |]
...
expect_digitListLenSepG = ([Pdigit 1,Pdigit 2,Pdigit 3,Pdigit 4,Pdigit 5],0,"ab6ab7ab")
...
expect_digitListLenSepB = ([Pdigit 1,Pdigit 2,Pdigit 3,Pdigit 0,Pdigit 5],1,"ab6ab7ab")
test_digitListLenSepB = mkTestCase "DigitListLenSepB" expect_digitListLenSepB result_digitListLenSepB


[pads| type DigitListTerm = [Pdigit] terminator EOR|]
input_digitListTermG = "12345\nhello"
result_digitListTermG = digitListTerm_parseS input_digitListTermG
expect_digitListTermG = ([Pdigit 1,Pdigit 2,Pdigit 3,Pdigit 4,Pdigit 5],0,"hello")
...
expect_digitListTermB = ([Pdigit 1,Pdigit 2,Pdigit 3,Pdigit 4,Pdigit 5,Pdigit 0,Pdigit 0],2,"")
test_digitListTermB   = mkTestCase "DigitListTermB" expect_digitListTermB result_digitListTermB

[pads| type DigitListTermSep = [Pdigit | '|' ] terminator ';' |]
input_digitListTermSepG = "1|2|3|4|5|6;hello"
result_digitListTermSepG = digitListTermSep_parseS input_digitListTermSepG 
expect_digitListTermSepG = ([Pdigit 1,Pdigit 2,Pdigit 3,Pdigit 4,Pdigit 5,Pdigit 6], 0,"hello")
...
[pads| type ListWithTry = ([Pchar] terminator (Try Pdigit), Pdigit) |]
...
expect_voidEntry1 = ((PDigit (Pdigit 9),PstringFW "abc"),0,"def")
...
expect_voidEntry2 = ((Pcolor,PstringFW "abc"),0,"def")
...
expect_voidEntry3 =  ((Pnothing,PstringFW "abc"),0,"def")
...
expect_pstringln = (PstringSE "hello",0,"goodbye")
...
expect_hp_data = ([HP {student_num = Pint 8, student_name = PstringFW "Hermione"},
...
expect_hp_data_file_parse = 
  ( [HP {student_num = Pint 8, student_name = PstringFW "Hermione"},
     HP {student_num = Pint 3, student_name = PstringFW "Ron"},
     HP {student_num = Pint 5, student_name = PstringFW "Harry"}], 0)
...
acomma = ","
[pads| data LitRec = LitRec { fstField :: Pint, acomma, sndField :: Pint} |]
litRec_input = "12,34"
...
whiteSpace_expects = ((Pint 12,Pint 34),0,"")
...
whiteSpace2_expects = ((Pint 12,Pint 34),0,"")
...
rE_ty_expects = ((Pre "t",Pre "aaaa"),0,"")
